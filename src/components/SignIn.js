...
// ..
  return (
    <>
      <div class='split rightl' style={{ backgroundColor: '#79c77e' }}>
        <img src="https://www.svgrepo.com/show/217771/shopping-logo.svg" class='imgw'/>
      </div>
                ...
                <div class="card-body">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-md-8 col-sm-8 col-8">
                      <input class="form-control " onChange={e => setEmail(e.target.value)} type="name" id="example-email-input" dir="ltr" />
                    </div>
                  </div>
